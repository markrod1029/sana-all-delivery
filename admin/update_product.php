 ...
 ?>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <select type = "text" class="form-control span8 tip" name="farmer_id"  onChange="getSubcat(this.value);"  required>
                            ...
                            <div class="input-group mb-3 ">
                        <label for="cono1" class="col-sm-2 text-right control-label col-form-label text-muted">Sub Category Name</label>

                        
                        <div class="input-group col-sm-8 col-xs-11">

                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa  fa-shopping-basket"></i></span></div>
                        <select type = "text"  name="subcategory" id="subcategory" class=" form-control span8 tip"  >
