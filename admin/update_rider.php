...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1 class="h3 mb-4 text-gray">Rider List</h1>
    </section>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col">
                    <h6 class="h3 m-0 font-weight-bold text-success">Rider Info</h6>
                    <?php
                    $ID = $_GET['id'];
                    $view = "SELECT * from rider where id = '$ID'";
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" method="POST" action="crud/update_rider.php" enctype="multipart/form-data" id="doctor_form">

                <div class="form-group  row">
                    <label for="fname" class="col-sm-2 text-right control-label col-form-label text-muted">Rider ID </label>
                    ...
                    <div class="input-group col-sm-8 col-xs-11">
                        ...
                        <input type="text" class="form-control" name="fname" id="title" value="<?php echo $row['user_id']; ?>" placeholder="Shop ID Here" required="">
                    </div>
                </div>
                ...
                <div class="form-group  row">
                    ...
                    <div class="input-group col-sm-8 col-xs-11">
                        ...
                        <input type="password" class="form-control" name="password" id="title" placeholder="Password Here"  >
                    </div>
                </div>
