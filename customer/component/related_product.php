			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<?php if($rw['productAvailability']=='Out of Stock' || $rw['quantity'] == 0  ){?>
			<div class="action" style="color:red">Out of Stock</div>

				<?php } else {?>
					<div class="action"><a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Add to Cart</a></div>
